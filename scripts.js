...
function CreateTeamFilters() {
	...
	var listItems = $('#our-team .team-filter li');
	var pics = $('#team-pics .col.team-member-img-col');
	
	$.each(listItems, function(index, elem) {
		
		var item = $(elem);
		var filterLink = $(item.children("a")[0]);
		var filter = filterLink.attr('filter');
